...
/**
 * Very basic class using the Citation.getId() method in order to search for duplicate PMC/PubMed IDs  
 * @author philippe
 *
 */
public class IdExtractor {
	...
	public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
		...
		job.setJarByClass(IdExtractor.class);
	...
	private static void printUsage() {
		System.err.println(
				"Returns Ids for documents to check for duplicates" + 
						"Usage:\n" +
						//						"Input folder [-i,--in]\n" +
						//						"Output folder [-o, --out]\n" +
